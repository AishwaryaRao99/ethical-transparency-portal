...
INSERT INTO SAVED_PRODUCTS (user_id, product_id, saved_at) VALUES (3, 1, NOW() - INTERVAL '13 days') ON CONFLICT (user_id, product_id) DO NOTHING;
INSERT INTO SAVED_PRODUCTS (user_id, product_id, saved_at) VALUES (3, 2, NOW() - INTERVAL '20 days') ON CONFLICT (user_id, product_id) DO NOTHING;
INSERT INTO SAVED_PRODUCTS (user_id, product_id, saved_at) VALUES (3, 3, NOW() - INTERVAL '30 days') ON CONFLICT (user_id, product_id) DO NOTHING;